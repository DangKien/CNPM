...
class CateSeeder extends Seeder
{
    ...
    public function run()
    {
    	DB::table('catetogys')->insert([
            ...
            ['name' => 'Chương trình học cho bé', 'slug'=>"chuong-trinh-hoc", 'cate_id'=>"0", 'user_create'=>"1"],
            ['name' => 'Chương trình học', 'slug'=>"chuong-trinh", 'cate_id'=>"6", 'user_create'=>"1"],
            ...
            ['name' => 'Tin tức', 'slug'=>"tin-tuc", 'cate_id'=>"0", 'user_create'=>"1"],

            ['name' => 'Thư viện', 'slug'=>"thu-vien", 'cate_id'=>"0", 'user_create'=>"1"],
            ['name' => 'Thư viện ảnh', 'slug'=>"thu-vien-anh", 'cate_id'=>"13", 'user_create'=>"1"],
            ['name' => 'Thư viện video', 'slug'=>"thu-vien-video", 'cate_id'=>"13", 'user_create'=>"1"],
            ['name' => 'Thư viện tài liệu', 'slug'=>"thu-vien-tai-lieu", 'cate_id'=>"13", 'user_create'=>"1"],

            ['name' => 'Tuyển sinh', 'slug'=>"tuyen-sinh", 'cate_id'=>"0", 'user_create'=>"1"],
            ['name' => 'Thông tin tuyển sinh', 'slug'=>"thong-tin-tuyen-sinh", 'cate_id'=>"17", 'user_create'=>"1"],
            ['name' => 'Hướng dẫn', 'slug'=>"huong-dan", 'cate_id'=>"17", 'user_create'=>"1"],
            ['name' => 'Đăng kí tuyển sinh Online', 'slug'=>"dang-ki-online", 'cate_id'=>"17", 'user_create'=>"1"],

            ['name' => 'Thông báo', 'slug'=>"thong-bao", 'cate_id'=>"0", 'user_create'=>"1"],

            ['name' => 'Liên hệ', 'slug'=>"lien-he", 'cate_id'=>"0", 'user_create'=>"1"],
        ]);
